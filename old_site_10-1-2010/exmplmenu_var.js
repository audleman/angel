...
Menu4=new Array("Professional Training","","",5);

	Menu4_1=new Array("Introduction","/introduction.html","",0,20,130);

	Menu4_2=new Array("Curriculum","/curriculum.html","",0);

	Menu4_3=new Array("Schedule - SEFT II","/trainscheduleII.htm","",0);

	Menu4_4=new Array("Schedule - SEFT III","/trainscheduleIII.htm","",0);

	Menu4_5=new Array("Faculty","/faculty.html","",0);




Menu5=new Array("Courses/Workshops","","",6);
	...
	Menu5_6=new Array("Mentoring","/mentoring.html","",0);
...
Menu6=new Array("Learning Material","","",3);
	...
	Menu6_2=new Array("Cassettes","/cassettes.html","",0);

	Menu6_3=new Array("Vocal Integration CD","/vocalCD.html","",0);
